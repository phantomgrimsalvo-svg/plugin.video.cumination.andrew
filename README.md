...
- Addon id: `plugin.video.cumination.andrew` **1.2.8**
...
- Zip: [`artifacts/plugin.video.cumination.andrew-1.2.8.zip`](artifacts/plugin.video.cumination.andrew-1.2.8.zip)
- Public download: https://github.com/phantomgrimsalvo-svg/plugin.video.cumination.andrew/releases/download/v1.2.8/plugin.video.cumination.andrew-1.2.8.zip
- Release: https://github.com/phantomgrimsalvo-svg/plugin.video.cumination.andrew/releases/tag/v1.2.8
